...
if test[0]['allowed'] is True:
    ...
    host_3.call('importissuanceblindingkey', txid, 0, issuanceblindingkey)
    host_4.call('importissuanceblindingkey', txid, 0, issuanceblindingkey)
    host_5.call('importissuanceblindingkey', txid, 0, issuanceblindingkey)
